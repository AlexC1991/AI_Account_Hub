"""Accounts dashboard screen (design section 3): 3-column layout.

Persistent by construction: the column widgets are built once. Selecting an
account updates the right-hand detail rail IN PLACE (no teardown/rebuild), and
a data refresh re-populates existing widgets rather than recreating them.
"""
